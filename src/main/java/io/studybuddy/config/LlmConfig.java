...
import io.studybuddy.llm.ClaudeStudyLlm;
import io.studybuddy.llm.DummyStudyLlm;
...
public class LlmConfig {
    ...
    @Bean
    StudyLlm studyLlm(StudyBuddyProperties properties) {
        StudyBuddyProperties.Claude claude = properties.claude();
        if (!claude.enabled()) {
