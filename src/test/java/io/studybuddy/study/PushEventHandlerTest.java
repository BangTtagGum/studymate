...
import io.studybuddy.webhook.PushEvent;
...
class PushEventHandlerTest {
    ...
    @BeforeEach
    void setUp() {
        StudyBuddyProperties props = new StudyBuddyProperties(
                new StudyBuddyProperties.Github("o", "r", "main", "t", null, null, null, null),
                new StudyBuddyProperties.Claude(null, null),
                new StudyBuddyProperties.Study(null, null, null, 0));
    ...
    void ignores_bot_commits_and_other_branches() {
        handler.handle(push("refs/heads/main", "jylee",
                commit("[study-buddy] 질문 생성", List.of("questions/2026-09-17.md"), List.of())));
        handler.handle(push("refs/heads/feature", "jylee",
                commit("study", List.of("notes/2026-09-17.md"), List.of())));
        handler.handle(push("refs/heads/main", "study-buddy",
                commit("study", List.of("notes/2026-09-17.md"), List.of())));
